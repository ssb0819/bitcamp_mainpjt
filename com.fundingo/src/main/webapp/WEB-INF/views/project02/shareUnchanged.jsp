  ...
  function sendLink() {
    Kakao.Link.sendDefault({ 
      ...
      content: {
        ...
        link: {
          mobileWebUrl: 'http://localhost:8080/project/getPjtList',
          webUrl: 'http://localhost:8080/project/getPjtList',
        },
      },
      commerce: {
      ...
      buttons: [
        {
          title: '펀딩하기',
          link: {
            mobileWebUrl: 'http://localhost:8080/project/getPjt/${project.pjtNo}',
            webUrl: 'http://localhost:8080/project/getPjt/${project.pjtNo}',
          },
        },
        {
          title: '펀딩고로 가기',
