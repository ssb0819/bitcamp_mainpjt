...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-10 col-md-10" style="font-size: 20px;">${pjtNotice.pjtNoticeTitle}</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-xs-10 col-md-10">
				<pre style="width: 550px; height: 400px;">${pjtNotice.pjtNoticeContents}</pre>
			</div>
		</div>
		...
		<hr />
			...
			<c:if test="${sessionScope.user != null && sessionScope.user.userNo == project.user.userNo}">
				<button type="button" class="designedBtn" style="width: 60px;">수 정</button>
				<button type="button" class="designedBtn" style="width: 60px;">삭 제</button>
			</c:if>
			<c:if test="${sessionScope.user != null && sessionScope.user.badge == '0'}">
				<button type="button" class="designedBtn" style="width: 60px;">수 정</button>
				<button type="button" class="designedBtn" style="width: 60px;">삭 제</button>
			</c:if>
			<button type="button" class="designedBtn" style="width: 60px;">목 록</button>
	</div>
