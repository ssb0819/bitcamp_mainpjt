                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                       ...
                       <div style="text-align : center"> <span class="startDate">시작일 : <fmt:formatDate var ="startDate" value="${project.startDate}" pattern="yyyy-MM-dd" />${startDate}</span>&nbsp;~
                        ...
                        <hr/>
                        <div style="text-align : center">목표금액 : <fmt:formatNumber value="${project.targetAmount}" pattern="#,###" />\
						</div>
                        <div style="text-align : center">
                        <span class="collectedAmount" style="text-align : center">모인 금액 : <fmt:formatNumber value="${project.collectedAmount}" pattern="#,###" />\</span>
                        </div><br>
									<div class="progress">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
								...
								<c:if test="${ ! empty project.user.profileImg }">
								  	<img class="profileImg" src="/static/img/profile/${project.user.profileImg}">
								</c:if>
								</a>									
								</div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div style="border: 1px solid lightgray; ">
	                        ...
	                        <div class="card-body" id="${product.prodNo}">가격 : <fmt:formatNumber value="${product.price}" pattern="#,###" />\</div>
