	    ...
	    <form class="form-horizontal" style="margin-left:10%;">
   			...
   			<div class="row">
	    		...
	    		<div class="col-sm-3">
	    			<c:if test="${funding.project.pjtStatus eq '07'}">
					 <input type="text" class="form-control-plaintext" id="pjtStatus" value="진행중" readonly>
					</c:if>
					<c:if test="${funding.project.pjtStatus eq '08'}">
					 <input type="text" class="form-control-plaintext" id="pjtStatus" value="일시정지" readonly>
					</c:if>
					<c:if test="${funding.project.pjtStatus eq '09'}">
					 <input type="text" class="form-control-plaintext" id="pjtStatus" value="삭제처리" readonly>
					</c:if>
					<c:if test="${funding.project.pjtStatus eq '10'}">
					 <input type="text" class="form-control-plaintext" id="pjtStatus" value="펀딩실패" readonly>
					</c:if>
					<c:if test="${funding.project.pjtStatus eq '11' || funding.project.pjtStatus eq '12'}">
					 <input type="text" class="form-control-plaintext" id="pjtStatus" value="펀딩성공" readonly>
					</c:if>	
	    		</div>
   			</div>
			<div class="row">
	    		...
	    		<div class="col-sm-3">
	    			<input type="text" class="form-control-plaintext" id="pjtName" value="${funding.project.pjtName}" readonly>
	    		</div>
   			</div>
			<div class="row">
          ...
          <div>
   		...
   		<div class="row">
   			...
   			<br>
   			<div class="row">
	    		<label style="margin-left:28%;" for="trackingNo" class="col-sm-2 control-label">택배사</label>
	    		<div class="col-sm-3">
	    			<c:if test="${funding.deliveryCompany eq '04'}">
					 <input type="text" class="form-control-plaintext form-control-sm" id="trackingNo" value="CJ대한통운">
					</c:if>
					<c:if test="${funding.deliveryCompany eq '05'}">
					 <input type="text" class="form-control-plaintext form-control-sm" id="trackingNo" value="한진택배">
					</c:if>
					<c:if test="${funding.deliveryCompany eq '08'}">
					 <input type="text" class="form-control-plaintext form-control-sm" id="trackingNo" value="롯데택배">
					</c:if>
					<c:if test="${funding.deliveryCompany eq '01'}">
					 <input type="text" class="form-control-plaintext form-control-sm" id="trackingNo" value="우체국택배">
					</c:if>
					<c:if test="${funding.deliveryCompany eq '06'}">
					 <input type="text" class="form-control-plaintext form-control-sm" id="trackingNo" value="로젠택배">
					</c:if>
					<c:if test="${funding.deliveryCompany eq '11'}">
					 <input type="text" class="form-control-plaintext form-control-sm" id="trackingNo" value="일양로지스">
					</c:if>
	    			<input type="hidden" class="form-control" name="t_code" id="t_code" required="" value="${funding.deliveryCompany}" />  			
	    		</div>
   			</div>
   			<br>
			<div class="row">
   		...
   		<%-- <form action="https://info.sweettracker.co.kr/tracking/4" method="post" target="_blank" style="padding-left: 10px;">
			<div class="row">
	    		<label style="margin-left:28%;" for="deliveryStatus" class="col-sm-2 control-label">배송상태</label>
	    		<div class="col-sm-3">
	    			<c:if test="${funding.deliveryStatus eq '0'}">
   			...
   			<input type="hidden" class="form-control" id="t_key" name="t_key" required=""  />
			<div class="row">
	    		<label style="margin-left:28%;" for="trackingNo" class="col-sm-2 control-label">운송장번호</label>
	    		<div class="col-sm-3">
	    			<input type="text" class="form-control-plaintext" name="t_invoice" id="t_invoice" required="" value="${funding.trackingNo}" readonly/>	    			
	    		</div>
   			</div>
