	...
	<div class="container">
		<div class="page-header text-default">
			<c:if test="${boardType == '0' }">
				<div style="color:#FF914D"><br><h3> 자유게시판 </h3></div>
			</c:if> 
			
			<c:if test="${boardType == '1' }">
				<div style="color:#FF914D"><br><h3> 공지사항 </h3> </div>
			</c:if> 
		...
		<table class="table table-hover table-striped">
			<thead>
				<tr>
					...
					<th align="left" style="text-align: center;">조회수</th>
				</tr>
			</thead>
			<tbody>
				...
				<c:forEach var="community" items="${list}">
					<tr>
						...
						<td align="left" style="cursor: pointer;">${community.postTitle}<input type="hidden"
							value="${community.postNo}" /></td>
						<td align="left">${community.nickname}</td>
						<td align="left">${community.postDate}</td>
						<td align="left" style="text-align: center;">${community.postHit}</td>
