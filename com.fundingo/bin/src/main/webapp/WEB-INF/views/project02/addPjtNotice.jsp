...
<script type="text/javascript">
	function fncAddPjtNotice() {
		...
		$('form').attr('method', 'POST').attr('action', '/project02/addPjtNotice').submit();
	}
			...
			<div class="row">
				...
				<div class="col-xs-8 col-md-4">
					<input class="form-control" type="text" name="pjtNoticeTitle"
						style="width: 500px;" maxlength="15"/>
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-xs-8 col-md-4">
					<textarea class="form-control" name="pjtNoticeContents"
						style="resize: none; height: 300px; width: 500px;" maxlength="260"></textarea>
