...
<body>
	...
	<br><br>
<a class="btn btn-success" style="margin-left:40%;width:200px;height:40px;" type="button" href="../funding/getFundList/${sessionScope.user.userNo}"  value="펀딩내역 보러가기">펀딩내역 보러가기</a>
<a class="btn btn-warning" style="height:40px;" type="button" href="http://localhost:8080" >펀딩 메인</a>
<br><br>
</body>
</html>