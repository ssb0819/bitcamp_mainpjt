...
<body>
	...
	<div class="container"  >
		...
		<c:forEach var="funding" items="${fundList}">
			<div class="col-sm-2">
					<label for="pjtName" class="form-label">펀딩번호</label>
            ...
            <div class="col-sm-2">
				...
				<div class="col-sm-2">
					<label for="fundDate" class="form-label">펀딩 날짜</label> 
					<input
