...
<%@ include file ="../sales/couponModal.jsp" %>
	...
	<form class="form-horizontal">
		<div class="row">
			<label style="margin-left: 38%; for="pjtName" class="col-sm-1 control-label">프로젝트명</label>
			<div class="col-sm-3">
		...
		<div class="row">
			<label style="margin-left: 38%;" for="recipName"
				class="col-sm-1 control-label">수령자명</label>
			<div class="col-sm-2">
		...
		<div class="row">
			<label style="margin-left: 38%;" for="addr"
				class="col-sm-1 control-label">수령자 주소</label>
			<div class="col-sm-5">
		...
		<br>
		<div class="row">
			<label style="margin-left: 38%;" for="price"
				class="col-sm-1 control-label">리워드 금액<br>(배송비 포함)</label>
			<div class="col-sm-2">
		...
		<div class="row">
			<!-- 수빈이쿠폰 넣을 부분 -->
			<label style="margin-left: 38%;" for="coupon"
				class="col-sm-1 control-label">쿠폰 차감 금액</label>
			<div class="col-sm-2">
		...
		<div class="row">
			<label style="margin-left: 38%;" for="fundAmount"
				class="col-sm-1 control-label">펀딩 총 금액</label>
			<div class="col-sm-2">
		...
		<div class="row">
			<label style="margin-left: 38%;" for="deliveryReq"
				class="col-sm-1 control-label">배송 요청사항</label>
			<div class="col-sm-3">
		...
		<div class="row">
			...
			<!--<input class="form-control" type="text" id="pInput" placeholder=""><br>  -->	
				...
				<br>
				<div class="col-sm-3">
				<a  class="btn btn-info" style="margin-left:20%;" href="#" role="button">이전</a>
