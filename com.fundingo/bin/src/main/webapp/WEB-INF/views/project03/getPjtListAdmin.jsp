						...
						success : function(pjtMap , status) {
							...
							$.each(pjtList, function(index, pjt){
								...
								var resultValue = '<tr>'
									  ...
									  +'<td align="center">'
										  +'<a href="http://localhost:8080/project/getPjt/'+pjt.pjtNo+'" target="_blank" data-toggle="tooltip" title="'+pjt.pjtName+'">'
										  +pjt.pjtNo
										  +'</a>'
										  +'<input type="hidden" value="'+pjt.pjtNo+'">'
									  +'</td>'
									  +'<td align="center">'
										 +'<a href="http://localhost:8080/user/getUser/'+pjt.user.userNo+'" target="_blank">'
										 +pjt.user.nickname
										 +'</a>'
		  ...
		  <c:forEach var="pjt" items="${pjtMap.pjtList}">
			...
			<tr>
			  ...
			  <td align="center" data-toggle="tooltip" data-placement="bottom" title="${pjt.pjtName}">
			  	<a href="http://localhost:8080/project/getPjt/${pjt.pjtNo}" target="_blank" >
			  		${pjt.pjtNo}
			  	</a>
			  </td>
			  <td align="center">
